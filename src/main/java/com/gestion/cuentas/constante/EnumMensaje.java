...
public enum EnumMensaje {
    INFORMACION_INVALIDA_CREAR_PRESUPUESTO_PERSONAL("Informacion invalida para crear presupuesto personal."),
    ...
    ERROR_ACTUALIZAR_CUENTA_NO_EXISTE("Error al actualizar debido a que la cuenta no existe."),
